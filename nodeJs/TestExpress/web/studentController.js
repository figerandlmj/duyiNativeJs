...
function getAllStudent(request, response) {
    studentDao.queryStudentCount(function(result) {
...
function addStudent(request, response) {
    ...
    studentDao.insertStudent(params.stuNum, params.name, params.age, params.class, params.pwd, params.ctime, function(result) {
        response.writeHead(200, {
